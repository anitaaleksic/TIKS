    ...
    <form className="reservation-form" onSubmit={handleSubmit}>
      <div className="form-group">
        ...
        <input type="text"
               ...
               onBlur={() => checkGuestExists(formData.guestID)}
        />
        {guestExists === false && (
            ...
            <div className="checkbox-group">
              ...
              {roomServices.map((service) => (
                <label key={service.roomServiceID} className="checkbox-item">
                  <input type="checkbox" name="roomServices" value={service.roomServiceID} onChange={() => handleRoomServiceChange(service.roomServiceID)} />
                  {service.itemName}
                </label>
              ))}
            </div>
            ...
            <div className="checkbox-group">
              ...
              {extraServices.map((service) => (
                <label key={service.extraServiceID} className="checkbox-item">
                  <input type="checkbox" name="extraServices" value={service.extraServiceID} onChange={() => handleExtraServiceChange(service.extraServiceID)}/>
                  {service.serviceName}
                </label>
              ))}
            </div>
