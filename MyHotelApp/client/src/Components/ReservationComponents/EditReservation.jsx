    ...
    <form className="reservation-form" onSubmit={handleSubmit}>
      ...
      <div className="form-group">
        ...
        <input
          ...
          onBlur={() => handleGuestCheck(formData.guestID)}
        />
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={handleChange}
          onBlur={() => handleRoomCheck(formData.roomNumber)}
        />
      ...
      <div className="button-pair-row">
        <div className="toggle-group-inline">
          <button type="button" className="form-button" onClick={() => setShowRoomServices(!showRoomServices)}>
            Room Services
          </button>
          {showRoomServices && (
        ...
        <div className="toggle-group-inline">
          <button type="button" className="form-button" onClick={() => setShowExtraServices(!showExtraServices)}>
            Extra Services
          </button>
          {showExtraServices && (
            <div className="checkbox-group">
              ...
              {extraServices.map((service) => (
                <label key={service.extraServiceID} className="checkbox-item">
                  <input
                    type="checkbox"
                    value={service.extraServiceID}
                    checked={formData.extraServiceIDs.includes(service.extraServiceID)}
                    onChange={() => handleExtraServiceChange(service.extraServiceID, setFormData)}
                  />
                  {service.serviceName}
                </label>
              ))}
      ...
      <button type="submit" className="form-button">Update Reservation</button>
      <button type="button" className="form-button delete" onClick={(e) => {
        e.preventDefault();
